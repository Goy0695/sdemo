...
object WordCount {
  def main(args:Array[String]): Unit ={
    ...
    //文本输出
    wordCounts.saveAsTextFile("src/main/resources/result.txt")
    sc.stop()
  }
}
